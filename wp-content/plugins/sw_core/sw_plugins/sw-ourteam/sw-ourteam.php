...
class sw_ourteam_slider_widget extends WP_Widget {
	...
	?>	
		...
		<h3><?php _e( 'Social', 'sw_core' ); ?></h3>
			...
			<p><label><b><?php _e('Instagram', 'sw_core'); ?>:</b></label><br/>
	...
	function team_save_meta( $post ){
		...
		$list_meta = array( 'facebook', 'twitter', 'gplus', 'linkedin', 'instagram', 'team_info' );
	...
	**/
	...
	public function widget( $args, $instance ) {
		...
		if( $instance['widget_template'] == 'default' ){
			include( 'includes/default.php' );
		}elseif( $instance['widget_template'] == 'theme1' ){
			include( 'includes/team-style1.php' );
		}else{
			include( 'includes/team-style2.php' );
		}
