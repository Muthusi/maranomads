						...
						<div class="item-detail">
							...
							<div class="entry-content">
								<div class="entry-meta">
									<span class="entry-date"><?php echo get_the_date('F j. Y', $post->ID);?></span>
								</div>
								...
								<a class="read-more" href="<?php echo get_permalink($post->ID)?>"><?php echo  esc_html('Read more', 'sw_core'); ?></a>
							</div>
						</div>
					</div>
				</div>
