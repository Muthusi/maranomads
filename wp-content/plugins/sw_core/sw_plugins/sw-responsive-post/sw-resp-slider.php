		...
		public function form( $instance ) {
			...
			<p>
				...
				<select class="widefat"
					...
					<option value="layout42" <?php if ($widget_template=='layout42'){?> selected="selected"
					<?php } ?>>
						<?php _e('Layout42', 'sw_core')?>
					</option>
					<option value="layout43" <?php if ($widget_template=='layout43'){?> selected="selected"
					<?php } ?>>
						<?php _e('Layout43', 'sw_core')?>
					</option>
				</select>
			</p>           
		<?php
