...
?>
<div id="<?php echo 'slider_' . $widget_id; ?>" class="responsive-slider sw-category-slider21 loading"  data-append=".resp-slider-container" data-lg="<?php echo esc_attr( $columns ); ?>" data-md="<?php echo esc_attr( $columns1 ); ?>" data-sm="<?php echo esc_attr( $columns2 ); ?>" data-xs="<?php echo esc_attr( $columns3 ); ?>" data-mobile="<?php echo esc_attr( $columns4 ); ?>" data-speed="<?php echo esc_attr( $speed ); ?>" data-scroll="<?php echo esc_attr( $scroll ); ?>" data-interval="<?php echo esc_attr( $interval ); ?>"  data-autoplay="<?php echo esc_attr( $autoplay ); ?>">
	<div class="box-left">
		<?php	if( $title1 != '' ){ ?>
		<div class="box-title">
			<h3><?php echo esc_html__('Shop by ','sw_woocommerce'); ?><span><?php echo $title1; ?></span></h3>
		</div>
		<?php } ?>
		<?php	if( $description != '' ){ ?>
			<div class="description1"><?php echo $description; ?></div>
		<?php } ?>
