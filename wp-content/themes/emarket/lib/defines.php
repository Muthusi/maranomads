	...
	$options[] = array(
		...
		'fields' => array(
			...
			array(
				...
				'type' => 'checkbox',
				'desc' => '',
				'sub_desc' => esc_html__( 'Turn On/Off shop categories breadcumb', 'emarket' ),
				'std' => '1'
				),
			...
			array(
				...
				'type' => 'checkbox',
				'desc' => '',
				'sub_desc' => esc_html__( 'Turn On/Off Product Style Variation', 'emarket' ),
				'std' => '1'
				),
			...
			array(
				...
				'type' => 'checkbox',
				'desc' => '',
				'sub_desc' => esc_html__( 'Turn On/Off buy now button on product single full background', 'emarket' ),
				'std' => '1'
			),		
			array(
				'id' => 'info_typo1',
